...
export class IntegrationConfiguration {
  ...
  public get integrationTypeId(): string | undefined {
  ...
  public get importName(): string | undefined {
  ...
  public get settings(): IntegrationSetting[] | undefined {
  ...
  private getNameToSettingMap(): Map<string, IntegrationSetting> | undefined {
  ...
  public getSettingByName(name: string): IntegrationSetting | undefined {
